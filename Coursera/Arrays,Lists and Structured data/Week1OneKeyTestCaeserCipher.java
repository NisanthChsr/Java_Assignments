...
public class Week1OneKeyTestCaeserCipher {
    ...
    private String breakCaesarCipher(String input) {
        ...
        Week1OneKeyCaeserCipher cc = new Week1OneKeyCaeserCipher(dkey);
    ...
    public void simpleTests() {
        ...
        Week1OneKeyCaeserCipher cc = new Week1OneKeyCaeserCipher(18);
    ...
    public static void main(String[] args) {
        Week1OneKeyTestCaeserCipher obj=new Week1OneKeyTestCaeserCipher();
        obj.simpleTests();
    }
}